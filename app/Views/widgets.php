					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="card card-post card-round">
								<img class="card-img-top" src="<?= base_url('azzara') ?>/assets/img/blogpost.jpg" alt="Card image cap">
								<div class="card-body">
									<div class="d-flex">
										<div class="avatar">
											<img src="<?= base_url('azzara') ?>/assets/img/profile2.jpg" alt="..." class="avatar-img rounded-circle">
										</div>
						...
						<div class="col-md-4">
							<div class="card card-profile card-secondary">
								<div class="card-header" style="background-image: url('<?= base_url('azzara') ?>/assets/img/blogpost.jpg')">
