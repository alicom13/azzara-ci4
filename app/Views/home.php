												...
												<table class="table">
													<tbody>
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url('azzara') ?>/assets/img/flags/id.png" alt="indonesia">
																</div>
															</td>
															<td>Indonesia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url('azzara') ?>/assets/img/flags/us.png" alt="united states">
																</div>
															</td>
															<td>USA</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url('azzara') ?>/assets/img/flags/au.png" alt="australia">
																</div>
															</td>
															<td>Australia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url('azzara') ?>/assets/img/flags/ru.png" alt="russia">
																</div>
															</td>
															<td>Russia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url('azzara') ?>/assets/img/flags/cn.png" alt="china">
																</div>
															</td>
															<td>China</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="<?= base_url('azzara') ?>/assets/img/flags/br.png" alt="brazil">
																</div>
															</td>
															<td>Brasil</td>
															<td class="text-right">
						...
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body pb-0">
									<div class="d-flex">
										<div class="avatar">
											<img src="<?= base_url('azzara') ?>/assets/img/logoproduct.svg" alt="..." class="avatar-img rounded-circle">
										</div>
									...
									<div class="d-flex">
										<div class="avatar">
											<img src="<?= base_url('azzara') ?>/assets/img/logoproduct2.svg" alt="..." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ml-2">
									...
									<div class="d-flex">
										<div class="avatar">
											<img src="<?= base_url('azzara') ?>/assets/img/logoproduct3.svg" alt="..." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ml-2">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										<div class="item-list">
											<div class="avatar">
												<img src="<?= base_url('azzara') ?>/assets/img/jm_denis.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
										...
										<div class="item-list">
											<div class="avatar">
												<img src="<?= base_url('azzara') ?>/assets/img/chadengle.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="<?= base_url('azzara') ?>/assets/img/talha.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="<?= base_url('azzara') ?>/assets/img/mlane.jpg" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
...
<!-- Moment JS -->
<script src="<?= base_url('azzara') ?>/assets/js/plugin/moment/moment.min.js"></script>

<!-- Chart JS -->
<script src="<?= base_url('azzara') ?>/assets/js/plugin/chart.js/chart.min.js"></script>

<!-- jQuery Sparkline -->
<script src="<?= base_url('azzara') ?>/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>

<!-- Chart Circle -->
<script src="<?= base_url('azzara') ?>/assets/js/plugin/chart-circle/circles.min.js"></script>

<!-- Datatables -->
<script src="<?= base_url('azzara') ?>/assets/js/plugin/datatables/datatables.min.js"></script>

<!-- Bootstrap Notify -->
<script src="<?= base_url('azzara') ?>/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>

<!-- Bootstrap Toggle -->
<script src="<?= base_url('azzara') ?>/assets/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js"></script>

<!-- jQuery Vector Maps -->
<script src="<?= base_url('azzara') ?>/assets/js/plugin/jqvmap/jquery.vmap.min.js"></script>
<script src="<?= base_url('azzara') ?>/assets/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>

<!-- Google Maps Plugin -->
<script src="<?= base_url('azzara') ?>/assets/js/plugin/gmaps/gmaps.js"></script>

<!-- Sweet Alert -->
<script src="<?= base_url('azzara') ?>/assets/js/plugin/sweetalert/sweetalert.min.js"></script>
...
<script src="<?= base_url('azzara') ?>/assets/js/demo.js"></script>
</body>
</html>